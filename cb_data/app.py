...
def load_data():
    try:
        gdf = gpd.read_file("../cb_streamlit/cb_tour.shp").to_crs(epsg=4326)
        gdf["lon"], gdf["lat"] = gdf.geometry.x, gdf.geometry.y
        boundary = gpd.read_file("../cb_streamlit/cb_shp.shp").to_crs(epsg=4326)
...
<div class="header-container">
    <img src="https://www.busan.com/nas/wcms/wcms_data/photos/2023/09/13/2023091318175372112_l.jpg" alt='누비다' style ="width:125px; height:125px">
    <div class="main-title">누비라 - 교통편 연계 DRT 서비스  </div>
</div>
...
# ✅ 메인 레이아웃 (2컬럼)
# ──────────────────────────────
col2, col1 = st.columns([3, 1.5], gap="large")
